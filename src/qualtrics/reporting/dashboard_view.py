...
def render_dashboard(entities: EntitySet, analysis: ReportAnalytics) -> str:
    ...
    return (
        ...
        "<label class='dashboard-toggle' for='dashboard-cumulative'>"
        "<input id='dashboard-cumulative' type='checkbox'>Cumulative</label></div></div>"
        "<div id='dashboard-timeline'></div><p id='dashboard-date-note' class='meta'></p>"
